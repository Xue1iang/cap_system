...
class TiltingEKF:
    ...
    def callback_imu(self, imu):
        ...
        self.depth_suscriber = rospy.Subscriber('/bluerov/mavros/global_position/rel_alt', Float64, self.callback_depthSensor)
        self.slam_susbcriber = rospy.Subscriber('/slam_out_pose', PoseStamped, self.callback_slam)
