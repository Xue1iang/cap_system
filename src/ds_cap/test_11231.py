...
class TiltingEKF:
    ...
    def __init__(self):
        ...
        self.previous_t_w2sb = self.t_w2sb.copy()
    ...
    def callback_imu(self, imu):
        ...
        rospy.Subscriber('/bluerov/mavros/global_position/rel_alt', Float64, self.callback_depthSensor)
        # rospy.Subscriber('/slam_out_pose', PoseStamped, self.callback_slam)
        # rospy.Subscriber('/projected_in_camera', PoseStamped, self.callback_camera)
        ...
        tf_W_B.sendTransform((self.t_w2sb[0], self.t_w2sb[1], self.t_w2sb[2]), (0,0,0,1), rospy.Time.now(), 'MallARD_003', 'World')
